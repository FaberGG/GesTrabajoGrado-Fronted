...
public class DocenteController {
    ...
    public boolean handleSubirAnteproyecto(String titulo, String modalidad, String descripcion, java.io.File archivo) {
    // Solo a modo de prueba (implementación dummy)
    System.out.println("Subir anteproyecto: " + titulo + ", " + modalidad + ", " + descripcion + ", archivo: " + archivo);
    ...
    public boolean handleCrearProyecto(ProyectoGradoRequestDTO request, java.io.File formatoA, java.io.File carta) {
        try {
            ...
            System.out.println("💾 Guardando propuesta: " + request.getTitulo());
            System.out.println("📄 Formato A: " + (formatoA != null ? formatoA.getName() : "No adjunto"));
            System.out.println("📋 Carta: " + (carta != null ? carta.getName() : "No adjunto"));

            ProyectoGradoResponseDTO response = handleCrearProyecto(request);
            boolean exitoso = response != null && response.getId() != null;

            System.out.println(exitoso ? "✅ Propuesta guardada exitosamente" : "❌ Error al guardar");
     ...
     */
    public List<Object> obtenerMisProyectos() {
        // TODO: Implementar llamada al microservicio
        return new ArrayList<>();
    }
