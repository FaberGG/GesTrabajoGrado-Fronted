...
/**
 * DTO para representar el historial de eventos de un proyecto
 * Mapea la respuesta del endpoint GET /api/progress/proyectos/{id}/historial
 */
public class ProyectoHistorialDTO {
    ...
    public List<EventoDTO> getHistorial() {
        return historial;
    }

    public void setHistorial(List<EventoDTO> historial) {
